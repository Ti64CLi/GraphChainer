...
public:
	...
	std::vector<size_t> colinearChaining(const std::vector<Anchor> &anchors, const std::vector<size_t> &anchors_node_offsets, long long sep_limit, std::bool using_symmetric_chaining) const;
